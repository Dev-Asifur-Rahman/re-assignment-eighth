  ...
  return (
    <div className="w-[95vw] mx-auto">
      ...
      <section style={{marginBottom:`420px`}} className={`${location.pathname === '/' ? (window.innerWidth > 768 ? 'inline-flex' : 'hidden') : 'hidden'} w-full lg:h-[70vh] bg-[#9538E2] relative rounded-[8px] flex-col items-center gap-4`}>
        ...
        <p  className="lg:text-5xl text-4xl font-bold text-center text-white w-[60%]">Upgrade Your Tech Accessorize with Gadget Heaven Accessories</p>
        <p className="text-base text-center font-bold text-white w-[60%]">Explore the latest gadgets that will take your experience to the next level. From smart devices to the coolest accessories, we have it all!</p>
